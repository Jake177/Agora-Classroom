...
// Make sure to set your APP_ID in config.js
const APP_ID = window.AGORA_CONFIG?.APP_ID || "your_app_id_here"

if (APP_ID === "your_app_id_here") {
    console.error("Please set your Agora APP_ID in js/config.js")
    alert("Please configure your Agora APP_ID. Check the README for instructions.")
}
